...
import EmporixStockService from './services/stock/impl/EmporixStockService';
...
export function initializeContainer(): Container {
  ...
  // Alias: StockService -> EmporixStockService
  if (container.isBound('EmporixStockService')) {
    if (container.isBound('StockService')) {
      container.unbind('StockService');
    }
    container.bind('StockService').toService('EmporixStockService');
  }
