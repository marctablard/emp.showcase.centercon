...
import { EmporixCartCheckoutRequest, EmporixCheckoutCustomer, EmporixPaymentMethod, EmporixShipping } from '@/platform/integrations/emporix/model';
...
class EmporixCheckoutService implements CheckoutService {
  ...
  async checkout(request: CheckoutRequest): Promise<CheckoutResponse> {
    ...
    const response = await (isGuest ? this.checkoutApi.guestCheckout(checkoutRequest) : this.checkoutApi.checkout(checkoutRequest));
    return response;
    /*
