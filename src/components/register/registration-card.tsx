...
export default function RegistrationCard() {
    ...
    return (
        <Card
            className="w-full sm:w-[584px] sm:my-[104px] sm:rounded-xl sm:border sm:shadow-sm rounded-none border-0 shadow-none gap-16">
            ...
            <CardContent>
                <Form {...form}>
                    <form id="register-form" onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-12">
                        ...
                        <Accordion type="multiple" className="flex flex-col gap-12"
