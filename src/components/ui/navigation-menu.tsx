...
function NavigationMenuLink({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "text-headlines [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm py-2 text-sm transition-all outline-none [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
